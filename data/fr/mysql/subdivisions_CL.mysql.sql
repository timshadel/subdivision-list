...
INSERT INTO `subdivision_CL` (`id`, `name`, `level`) VALUES ('CL-AI', 'Région Aisén del General Carlos Ibáñez del Campo', 'region');
...
INSERT INTO `subdivision_CL` (`id`, `name`, `level`) VALUES ('CL-RM', 'Région métropolitaine de Santiago', 'region');
