...
INSERT INTO `subdivision_CL` (`id`, `name`, `level`) VALUES ('CL-AT', 'Atakama', 'region');
...
INSERT INTO `subdivision_CL` (`id`, `name`, `level`) VALUES ('CL-LI', 'Libertador', 'region');
INSERT INTO `subdivision_CL` (`id`, `name`, `level`) VALUES ('CL-ML', 'Maule', 'region');
INSERT INTO `subdivision_CL` (`id`, `name`, `level`) VALUES ('CL-RM', 'Region Metropolitalny', 'region');
