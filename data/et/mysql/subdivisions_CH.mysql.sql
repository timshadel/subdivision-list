...
INSERT INTO `subdivision_CH` (`id`, `name`, `level`) VALUES ('CH-AG', 'Aargau kanton', 'canton');
...
INSERT INTO `subdivision_CH` (`id`, `name`, `level`) VALUES ('CH-GR', 'Graubündeni kanton', 'canton');
...
INSERT INTO `subdivision_CH` (`id`, `name`, `level`) VALUES ('CH-TG', 'Thurgau kanton', 'canton');
INSERT INTO `subdivision_CH` (`id`, `name`, `level`) VALUES ('CH-TI', 'Ticino kanton', 'canton');
