...
INSERT INTO `subdivision_IE` (`id`, `name`, `level`) VALUES ('IE-LS', 'Comtat de Laois', 'county');
INSERT INTO `subdivision_IE` (`id`, `name`, `level`) VALUES ('IE-WH', 'Comtat de Westmeath', 'county');
